...
const sections = computed<Section[]>(() => [
  { key: 'learning', label: t('admin.section.learning'), icon: 'book', items: [
    ...
    { to: '/admin/catalog/requests', label: t('admin.nav.catalogRequests'), show: hasScope('assignment.create') },
    { to: '/admin/catalog/access', label: t('admin.nav.catalogAccess'), show: hasScope('assignment.create') },
    { to: '/admin/comments', label: t('admin.nav.comments'), show: hasScope('course.view') },
  ...
  { key: 'people', label: t('admin.section.people'), icon: 'people', items: [
    ...
    { to: '/admin/development/strategic', label: t('admin.nav.goalsTree'), show: hasScope('development.team') },
    { to: '/admin/development/strategic-plans', label: t('admin.nav.strategic'), show: hasScope('development.team') },
