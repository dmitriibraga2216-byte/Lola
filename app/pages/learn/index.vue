...
const sections = computed(() => [
  { to: '/learn/trajectories', label: t('traj.short') }, { to: '/learn/programs', label: t('prog.short') }, { to: '/learn/meetups', label: t('mt.short') }, { to: '/learn/knowledge', label: t('kb.short') }, { to: '/learn/wiki', label: t('wiki.short') }, { to: '/org-structure', label: t('org.short') }, { to: '/learn/news', label: t('news.short') }, { to: '/learn/development', label: t('dev.short') },
