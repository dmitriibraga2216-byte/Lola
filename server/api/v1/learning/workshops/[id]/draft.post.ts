...
const schema = z.object({ text: z.string().max(5000).optional(), files: z.array(workshopFileSchema).optional(), enrollmentId: z.string().uuid().optional(), lessonId: z.string().uuid().optional() })
