...
import { clientIp, isSecureRequest } from '../../../utils/authCookies'
...
export default defineEventHandler(async (event) => {
  ...
  setCookie(event, PLATFORM_COOKIE, r.token, { httpOnly: true, secure: isSecureRequest(event), sameSite: 'strict', maxAge: 12 * 3600, path: '/' })
