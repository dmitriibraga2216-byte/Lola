...
export default defineEventHandler(async (event) => {
  ...
  const scope = narrowScope(await reportScope(a, 'assessment.team'), q.locationId)
  return apiData(await assessmentReport({ tenantId: a.tenantId, actorId: a.userId }, { ...q, scope }))
})
