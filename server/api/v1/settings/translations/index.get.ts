...
const q = z.object({ locale: z.enum(['uk', 'en', 'ru']).default('uk'), q: z.string().max(200).optional(), changedOnly: z.coerce.boolean().optional(), page: z.coerce.number().int().min(1).optional(), perPage: z.coerce.number().int().min(1).max(500).optional() })
