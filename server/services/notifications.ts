...
export const DEFAULT_TEMPLATES: Record<string, string> = {
  ...
  // docs/v2/34 §8 (PR-36): хранилище. Отложенная загрузка при исчерпанной квоте — сотруднику
  // и администраторам; итог массового удаления — инициатору. Пороги 80/95/100 % идут общими
  // limit_warning / limit_exceeded по оси storage_bytes (docs/v2/35 §8, В-16), своих кодов нет
  storage_upload_blocked: '{{n}} відповідей співробітників очікують вивантаження ({{size}}). Звільніть місце або збільште сховище',
  storage_upload_deferred: 'Відповідь збережено. Файл відправиться автоматично, щойно в сховищі компанії з\'явиться місце',
  ...
  // docs/v2/30 §8 (PR-27): `ai.provider_down` — пять отказов профиля подряд, админу, колокольчик.
