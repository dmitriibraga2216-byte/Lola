...
const ALLOWLIST: Record<string, string> = {
  ...
  // Строка сдвинулась 151 → 155 в fix-candidate-access: `createSession()` выше по файлу получил
  // проверку права входа кандидата (docs/v2/28 §7.7) — тот самый «контур доступа», о котором
  // говорит абзац выше. Сама выборка не менялась.
  'server/services/session.ts:155':
