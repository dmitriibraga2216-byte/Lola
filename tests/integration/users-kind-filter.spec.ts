...
const ALLOWLIST: Record<string, string> = {
  ...
  // Номера сдвинулись в fix-seat-limit (+1 импорт в шапке, +13 проверка мест в `applyImport`:
  // 179/180 → 180/181, 614/615 → 628/629, 634 → 648). Сами выборки не менялись.
  ...
  // затем 634 → 648 в fix-seat-limit (см. выше).
  'server/services/importPeople.ts:648':
  ...
  // Номер сдвинулся с 398 на 444 в PR-28: выше по файлу у `ScoreRow` появился признак
